...
public class everland_process {
	...
	String[] prefText= {"장애인 우대할인","국가유공자 우대할인","다자녀 우대할인","임산부 우대할인","나이할인 적용"};

	int totalPrice=0, age=0;

	int priceSetADate[]= {20210904,20210905,20210911,20210912,20210918,20210919,20210920,20210921,20210922,20210925,20210926,20211002,20211003,20211009,20211010,20211016,20211017,20211023,20211024,20211030,20211031,20211106,20211107};
