...
public class everland2 {
	...
	public static void main(String[] args) {
		...
		String[] prefText= {"장애인","국가유공자","다자녀","임산부"};
		...
		if ( (inputIdfNum < 999999) && (inputIdfNum > 300000) ) {
		...
		if (inputPref==1) {
			System.out.printf("%s티켓 %sX%d장 총 %d원 \n",ticketKind,ageText,inputQuantity,totalPrice);
			
			
		}
		else {
			System.out.printf("%s티켓 %sX%d장 총 %d원 %s 우대 적용\n",ticketKind,ageText,inputQuantity,totalPrice,pref);
		}
