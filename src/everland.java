...
public class everland {
	...
	public static void main(String[] args) {
		...
		ArrayList<String> saveTicketKind = new ArrayList<String>();
		ArrayList<String> saveAgeText = new ArrayList<String>();
		ArrayList<Integer> saveQuantity = new ArrayList<Integer>();
		ArrayList<Integer> savePrice = new ArrayList<Integer>();
		ArrayList<String> savePref = new ArrayList<String>();
